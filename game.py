...
def draw():
        ...
        for i in range(len(lasersY)):
                pygame.draw.rect(screen, (255, 0, 0), (lasersX[i], lasersY[i], PlayerWidth, PlayerHeight)) 

        for i in range(len(enemyY)):
                pygame.draw.rect(screen, (0, 255, 0), (enemyX[i], enemyY[i], enemyWidth, enemyHeight)) 
